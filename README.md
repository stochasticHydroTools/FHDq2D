...
The equations are summarized in the documentation file GiantFluct_2D.pdf. The full nonlinear equation is Eq. (3) in this documentation. But the code can also solve a linearized version of this equation, see Eq. (13) in the documentation. As explained in the paper, for quasi2D we really solve the simplified Eq. (4) in the documentation, not Eq. (3). To do this, set velMode=-1 and alpha=0 to remove the compressible component of the velocity and the background (equilibrium) fluctuations.
